...
class ChecklistItemsControllerTest < ActionController::TestCase
  ...
  test "should create checklist_item" do
    assert_difference('ChecklistItem.count') do
      post :create, checklist_item: { check_description: @checklist_item.check_description, check_name: @checklist_item.check_name }
    end
  ...
  test "should update checklist_item" do
    patch :update, id: @checklist_item, checklist_item: { check_description: @checklist_item.check_description, check_name: @checklist_item.check_name }
    assert_redirected_to checklist_item_path(assigns(:checklist_item))
  end
