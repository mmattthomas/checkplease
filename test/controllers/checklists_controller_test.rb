...
class ChecklistsControllerTest < ActionController::TestCase
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post :create, checklist: { description: @checklist.description, expires_on: @checklist.expires_on, name: @checklist.name }
    end
  ...
  test "should update checklist" do
    patch :update, id: @checklist, checklist: { description: @checklist.description, expires_on: @checklist.expires_on, name: @checklist.name }
    assert_redirected_to checklist_path(assigns(:checklist))
  end
